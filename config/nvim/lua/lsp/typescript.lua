...
require("typescript-tools").setup({
	on_attach = function(client, bufnr)
		...
		common.create_on_attach()(client, bufnr)

		-- Set up autocmd for organize imports and remove unused on save
		vim.api.nvim_create_autocmd("BufWritePre", {
			buffer = bufnr,
			group = vim.api.nvim_create_augroup("TypescriptTools" .. bufnr, { clear = true }),
			callback = function()
